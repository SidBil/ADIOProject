#!/usr/bin/env python3
"""
Generate img_001 at 9:10 ratio for quality preview.

gpt-image-1 doesn't support 9:10 natively, so we:
  1. Generate at 1024x1536 (2:3, portrait)
  2. Center-crop height from 1536 → 1138 to get ~9:10 (1024x1138)

Output: imagegen/images/img_001_9x10_preview.png
"""
...
# Center-crop to 9:10 → target height = round(width * 10/9)
w, h = img.size
target_h = round(w * 10 / 9)
top = (h - target_h) // 2
img_910 = img.crop((0, top, w, top + target_h))
print(f"Cropped to 9:10: {img_910.size}")

out_path = OUT_DIR / "img_001_9x10_preview.png"
img_910.save(out_path, "PNG")
